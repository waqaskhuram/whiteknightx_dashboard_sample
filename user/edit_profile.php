...
$sql_update_meta = "UPDATE users SET company_name = '$company_name', first_name = '$first_name', last_name = '$last_name', email_address = '$email_address', billing_address = '$billing_address', cell_phone = '$cell_phone', office_phone = '$office_phone' WHERE username='$username'";
$result_update= mysqli_query($link,$sql_update_meta);
if($result_update){
    $message="Success";
} else{
    $message= "ERROR: Could not able to update $sql_update_meta. " . mysqli_error($link);
		        ...
		        <div class="card-body">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <input disabled id="username" name="username" value="<?php echo $username; ?>" class="form-control here" required="required" type="text">
                                </div>
                              </div>
                              <div class="form-group row">
                              ...
                              <label class="text-success">Message here: </label><?php echo $message; ?><br>
                            </form>
